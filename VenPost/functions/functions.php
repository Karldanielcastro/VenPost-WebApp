         ...
         if ($profile_image == ""){
            ...
            <div class='col-md-6 ' style='margin-bottom:100px'>
               ...
               <div class='card cardprod'>
                  ...
                  <button name='subject' type='submit' value='$post' class='btn float-end cart'><i class='fa-$icon fa-heart' style='color: #e4d9d7;font-size:20px;margin-top:50px;margin-right:10px'><sup>$add</sup></i></button>
               </form> 
                  </div>
                  <!-- Card Des End -->
               </div>
